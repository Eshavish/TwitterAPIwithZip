...
ul.tweet-actions {width:80%; }
ul.tweet-actions li {float:right; padding:0px !important; text-align:center;  display:block; }
ul.tweet-actions li  a {display:block; width:100%; height:100%; margin:0px; padding:10px;  }

p.e-entry-title {padding:10px 0px 10px 0px !important; font-size:110% !important;}
p.e-entry-title a {color:#00A8E8 !important;}

div.media {text-align:center !important; }
div.media a.photo-link img {width:100%; height:auto; }


div.dateline {font-size:100% !important; }

.expanded .footer {padding-top:0px !important; }



blockquote,blockquote p,blockquote ol,blockquote ul,blockquote li,blockquote iframe,blockquote button {
    padding: 0;
    margin: 0;
