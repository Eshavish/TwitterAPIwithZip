  ...
  body.fixed
    nav.navbar.navbar-static-top.navbar-inverse(role="navigation")
      ...
      ul.nav.navbar-nav.navbar-right
        li#nav-bookmark(style='display:none;')
    ...
    .mainContent
      .section-search
              ...
              .row.form-group
                  ...
                  .input-group.input-group-sm
                    ...
                    .btn-group.btn-group-sm.search-viewMode(data-toggle="buttons")
                      ...
                      label.btn.btn-default.active
                        input(type='radio', name="search-viewMode", checked="checked", value='both')
                        | Both						
                .col-xs-6.col-md-6.toolbar
                  ...
                  .btn-group.btn-group-sm.pull-right(role='group')
                    ...
                    button#btn-search.btn.btn-primary(type="button") 
                      | Search
                      span.glyphicon.glyphicon-refresh.glyphicon-refresh-animate.loading
                  .btn-group.btn-group-sm.btn-afterLogin(style='float:right; margin-right:10px; display:none;')
                    button#btn-download.btn.btn-success(type="button") Download
                    button#btn-bookmark.btn.btn-default(type="button") Save Search
                    //button.btn.btn-success.dropdown-toggle(data-toggle="dropdown")
                      //span.caret
                      //span.sr-only Toggle Dropdown
                    //ul.dropdown-menu(role='menu')
                      //li
                        //a(href="#" value="bookmark") Bookmark
              .row.form-group
                .col-xs-12.col-md-12
        ...
        ul.searchToolbar.nav.navbar-nav
          ...
          li#tbx-note
            a.dropdown-toggle.dropdown-sort(href="#", data-toggle="dropdown", role='button' title='Switch Note topic') 
              label
                i.fa.fa-tags
                | 
              span.caret
            ul.dropdown-menu(role='menu')
          li
            a.dropdown-toggle.dropdown-sort(href="#", data-toggle="dropdown", role='button')#tbx-sort
              label
            ...
            ul.dropdown-menu(role='menu')
              li
                a(href="#" value='append' type='sort')
                  i.fa.fa-sort-amount-asc
                  | Oldest First
              li
                a.active(href="#" value='prepend' type='sort')
                  i.fa.fa-sort-amount-desc
                  | Newest First
          li 				
            a.dropdown-toggle.dropdown-playpause(href='#', data-toggle='dropdown', role='button')
              label
                i.fa.fa-play 
                | Realtime
              span.caret
          ...
          .modal-body
            form(action="", method="post" id='formLogin')
              ...
              button.btn.btn-primary.btn-block(type="submit") Sign me in
                span.glyphicon.glyphicon-refresh.glyphicon-refresh-animate.loading#loginLoading
              p
      ...
      .modal-dialog.modal-lg
        .modal-content
          .modal-header
            .header Tutorial
          .modal-body
            iframe(src="https://www.youtube.com/embed/eJYTmi6McWc?enablejsapi=1&autohide=1&showinfo=0&controls=2" frameborder="0" allowfullscreen)
            //.row
              //.col-xs-12.col-md-12
    ...
    // popup bookmark
    #popup_bookmark.modal.fade.form-box
      .modal-dialog.modal-lg
        .modal-content
          .modal-header 
            .header Save Search
            ...
            .row.form-group
              .col-xs-12.col-md-12
                .input-group.input-group-sm			    
                  ...
                  input#bookmark-name.form-control(type="text", placeholder="Name")  
            .row.form-group
              .col-xs-12.col-md-12
                .input-group.input-group-sm			    
                  span.input-group-addon Description
                  input#bookmark-name.form-control(type="text", placeholder="Description")
            .btn-group
                button.btn.btn-default(role='button' data-dismiss="modal") Cancel
                button.btn.btn-primary(role='button' href='#' value='submit' onclick='run.bookmark("submit")') Submit
                  span.glyphicon.glyphicon-refresh.glyphicon-refresh-animate.loading
            .panel.panel-default
              .panel-heading Parameters
              .row
                .col-xs-6.col-md-6
                  #bookmark-map
                .col-xs-6.col-md-6
    ...
    // popup confirm
    #popup_confirm.modal.fade.form-box
      .modal-dialog.modal-lg
        .modal-content
          .modal-header 
            .header Confirm
          ...
          .modal-footer
            .btn-group
                img.loading(src='images/loading.gif' style='display:none; float:left; ')
                button.btn.btn-default(role='button' data-dismiss="modal") No
                button.btn.btn-primary(role='button' href='#' value='submit') Yes
    // popup tag
    #popup_tag.modal.fade.form-box
      .modal-dialog.modal-lg
        .modal-content
          .modal-header 
            .header Tag Tweet
          .modal-body
            ...
            .row.form-group
              .col-xs-6.col-md-6
                .form-group#tag-topic
                  label 1. Event Type
                  span.description Please select a event to decide the label schema  
                  select#tag-theme.selectpicker
              .col-xs-6.col-md-6
                .form-group 			  
                  label 2. Color & Label
                    span 
                  span.description Please select a color 
                  .btn-group#tag-color
                    button.btn.btn-default(data-level=0 title='None' data-class='btn-default' style='display:none; ')
                    button.btn.btn-success(data-level=1 title='Safe' data-class='btn-success')
                      i.fa.fa-check
                    button.btn.btn-info(data-level=2 title='Info' data-class='btn-info')
                    button.btn.btn-primary(data-level=3 title='Primary' data-class='btn-primary')
                    button.btn.btn-warning(data-level=4 title='Warning' data-class='btn-warning')
                    button.btn.btn-danger(data-level=5 title='Danger' data-class='btn-danger')
            .row
              .col-xs-6.col-md-6
                .form-group 			  
                  label 3. Sentiment
                    span
                  span.description Please select a sentiment
                  .btn-group.btn-group-sm#tag-sentiment(data-toggle="buttons")
                    label.btn.btn-default.active
                      input(type='radio', checked="checked", value='none')
                      i.fa.fa-question
                      span Unknown
                    label.btn.btn-default
              ...
              .col-xs-6.col-md-6
                .form-group			  
                  label 4. Tags
                  span.description Please input tags separated with comma
                  input#tag-tags.form-control(type="text", placeholder="Please use ',' for multiple tags") 
          .modal-footer  
              img.loading(src='images/loading.gif' style='display:none;')
              button.btn.btn-default(role='button' data-dismiss="modal") Cancel
              button.btn.btn-primary(role='button' href='#' value='submit' onclick='run.tag()') Submit
    // popup intro 
    ...
    //alert-success
    .alert.alert-success.alert-popup(role='alert')
