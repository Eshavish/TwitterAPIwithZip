...
Twitter.prototype.getblocks = function (params, error, success) {
...
Twitter.prototype.getretweets = function (params, error, success) {
...
Twitter.prototype.getfriendships = function (params, error, success) {
    var path = '/friendships/show.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success);
};
Twitter.prototype.getblocked = function (params, error, success) {
...
Twitter.prototype.saveTweets = function (params, error, success) {
    var path = '/saved_searches/list.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success);
};
//molina code
